...
//
// float va double mitoonan adad-haye ashari ro negah daran.
//
// Challenge:
//
...
void exercise05()
{
    ...
    double result1 = a / b;    // hamoon 7/2 — chera ashar nist?
    double result2 = 7.0 / b;
    double result3 = a / 2.0;
...
// IMPORTANT:
//
// Behavior-e daghigh-e overflow baraye signed int dar C++
// mozoo-e pichide-tari ast. Hadaf-e in exercise in-e ke
...
// chand byte faza eshghal mikone.
//
// Mesalan:
//
//     sizeof(int)
...
// Tozih Finglish:
//
// const yani variable bad az meghdar-dehi-ye avalie
// nabayad taghir kone.
//
// Mesalan:
//
...
// Tozih Finglish:
//
// Variable-ha hamishe dar kol-e program ghabel-e dastresi nistand.
//
// Variable-i ke dakhele { } sakhte mishe,
// mamoolan faghat dakhele hamoon scope ghabel-e estefade ast.
//
// Mesal:
//
//     {
...
//     }
//
// Kharej az in block, x dige ghabel-e dastresi nist.
//
// Challenge:
//
// Ghabl az run kardan pish-bini kon kodoom x chap mishe.
//
// ============================================================
...
// Se ta x darim!
//
// Har kodom mota-allegh be kodoom scope hast?
// }
...
// Tozih Finglish:
//
// In exercise chand concept ro ba ham tarkib mikone.
//
...
// C++ momkene meghdar ro convert kone.
//
// Challenge:
//
// Ghabl az run tamam-e output-ha ro rooye kaghaz benevis.
//
// ============================================================
...
// ========================================================
// TAMRIN-E PAYANI (bedoon ejra javab bede):
// ========================================================
//
// 1. Chera b double ast na int? (hint: noe variable mohem ast,
//    na faghat meghdari ke dakhelesh mirizi.)
// 2. Chera .99 vaghti c dakhel-e d rikhte shod az dast raft?
// 3. Chera e (char) yek character chap mikone? (hint: ASCII 65 = 'A')
// 4. Chera f (int) yek adad chap mikone?
// 5. Chera g (bool) barabar-e 1 shod? (hint: harchi gheyr az 0 -> true)
// 6. Kodom tabdil-ha automatic (khodkar) budan?
// 7. Kodom tabdil-ha ro TO khodet ba cast darkhast kardi?
// 8. Kodom variable-ha etelaat-e yeksan daran vali ba type-haye
//    motafavet neshoon dade mishan?
// ========================================================
...
int main() {
    // Yeki-yeki az comment dar biar va ejra kon:
    // exercise01();
    // exercise02();
    // exercise03();
    // exercise04();
